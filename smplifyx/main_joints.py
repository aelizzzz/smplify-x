...
# Modified to take height and weight as input
# Only works for one image and the keypoints for one person in it
...
from cmd_parser_joints import parse_config
from data_parser import create_dataset
from fit_single_frame_joints import fit_single_frame
