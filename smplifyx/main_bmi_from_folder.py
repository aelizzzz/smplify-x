...
# Modified to take as input a folder containing json files with height and weight info
# Only works if each image corresponds to keypoints for only one person
...
from cmd_parser_bmi_from_folder import parse_config
from data_parser import create_dataset
from fit_single_frame_bmi_joints import fit_single_frame_bmi
